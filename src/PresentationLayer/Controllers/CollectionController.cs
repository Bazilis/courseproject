...
namespace PresentationLayer.Controllers
{
    public class CollectionController : Controller
    {
        ...
        public CollectionController(IItemService items, ICollectionService collections)
        {
            _items = items;
        ...
        [Authorize]
        public IActionResult Delete(int collectionId, int userId)
        {
            _collections.DeleteCollectionById(collectionId);
