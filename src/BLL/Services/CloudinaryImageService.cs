...
namespace BLL.Services
{
    public class CloudinaryImageService : ICloudinaryImageService
    {
        ...
        public async Task<ImageUploadResult> AddImageToCloudinaryAsync(IFormFile file)
        {
        ...
        public async Task<DeletionResult> DeleteImageFromCloudinaryAsync(string publicId)
        {
